...
export function WhatsAppFloat() {
  ...
  return (
    <div className="fixed z-50 bottom-4 right-4 md:bottom-8 md:right-8">
      ...
      {/* Logo tooltip - shows permanently once loaded */}
      {showLogoTooltip && !showOptions && (
        <div className="absolute -top-16 -left-4 right-0 flex items-center justify-center animate-fade-in-up animate-whatsapp-logo">
          <div className="bg-green-600 text-white px-4 py-2 rounded-lg text-sm font-medium shadow-lg flex items-center space-x-2 border-2 border-green-400">
